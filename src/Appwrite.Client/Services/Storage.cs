...
namespace Appwrite.Client.Services
{
    public class Storage : Service
    {
        ...
        /// </para>
        /// </summary>
        public string GetFilePreview(string fileId, int? width = 0, int? height = 0, string gravity = "center", int? quality = 100, int? borderWidth = 0, string borderColor = "", int? borderRadius = 0, int opacity = 0, int? rotation = 0, string background = "", string output = "") 
        {
